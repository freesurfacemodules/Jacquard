  ...
  assembly: {
    ...
    emit(planNode, helpers) {
      ...
      return [
        ...
        helpers.indentLines("if (pitchOffset > 10.0) pitchOffset = 10.0;", 1),
        helpers.indentLines("cutoffHz *= fastExp2(pitchOffset);", 1),
        helpers.indentLines("if (cutoffHz < 20.0) cutoffHz = 20.0;", 1),
        helpers.indentLines("if (cutoffHz > maxCutoff) cutoffHz = maxCutoff;", 1),
        ...
        helpers.indentLines(
          [
            ...
            `fastSinCosInto(Mathf.PI * normalized, biquad_trig_${identifier});`,
            `const sinPiF: f32 = biquad_trig_${identifier}.sin;`,
            `const cosPiF: f32 = biquad_trig_${identifier}.cos;`,
