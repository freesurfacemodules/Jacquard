      ...
      return [
        ...
        helpers.indentLines(
          [
            ...
            "if (driveParam > 1.0) driveParam = 1.0;",
            "let driveBase: f32 = 1.0 + driveParam;",
            "if (driveBase < 0.0) driveBase = 0.0;",
            "const driveSquare: f32 = driveBase * driveBase;",
            "const driveFourth: f32 = driveSquare * driveSquare;",
            "const driveGain: f32 = driveFourth * driveBase;",
